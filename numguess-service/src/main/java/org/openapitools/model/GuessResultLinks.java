...
@JsonTypeName("GuessResult__links")
...
public class GuessResultLinks {
   ...
   */
  public GuessResultLinks(Link self) {
    this.self = self;
  }

  public GuessResultLinks self(Link self) {
    this.self = self;
    return this;
  }
  ...
  public GuessResultLinks submitGuess(@Nullable Link submitGuess) {
    this.submitGuess = submitGuess;
    return this;
  }

  /**
   * Action link to submit another guess (only if game still active)
   * @return submitGuess
   */
  @Valid 
  @Schema(name = "submit-guess", description = "Action link to submit another guess (only if game still active)", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  public GuessResultLinks delete(@Nullable Link delete) {
    this.delete = delete;
    return this;
  }
  ...
  public GuessResultLinks newGame(@Nullable Link newGame) {
  ...
  public GuessResultLinks games(@Nullable Link games) {
    this.games = games;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GuessResultLinks guessResultLinks = (GuessResultLinks) o;
    return Objects.equals(this.self, guessResultLinks.self) &&
        Objects.equals(this.submitGuess, guessResultLinks.submitGuess) &&
        Objects.equals(this.delete, guessResultLinks.delete) &&
        Objects.equals(this.newGame, guessResultLinks.newGame) &&
        Objects.equals(this.games, guessResultLinks.games);
  }
  ...
  public String toString() {
    ...
    sb.append("class GuessResultLinks {\n");
